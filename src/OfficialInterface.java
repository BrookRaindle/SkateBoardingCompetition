...
public class OfficialInterface {
    ...
    private void handleRegisterCompetitorLateButtonClick() {
        String competitorTypeStr = JOptionPane.showInputDialog(frame, "Enter competitor type (1 for Surfer, 2 for Skater):");
        if (competitorTypeStr != null && !competitorTypeStr.isEmpty()) {
            ...
            if (competitorNumberStr != null && !competitorNumberStr.isEmpty()) {
                ...
                String level = JOptionPane.showInputDialog(frame, "Enter skill level:");
            ...
            JOptionPane.showMessageDialog(frame, "Invalid competitor type. Please enter 1 for Surfer or 2 for Skater.");
        }
    }
    ...
    private void handleAmendCompetitorDetailsButtonClick() {
        ...
        if (competitorIdStr != null && !competitorIdStr.isEmpty()) {
            ...
            if (competitor != null) {
                ...
                String choiceStr = JOptionPane.showInputDialog(frame, "Choose what to amend:\n" + choices);
                if (choiceStr != null && !choiceStr.isEmpty()) {
                    ...
                    JOptionPane.showMessageDialog(frame, "Details amended successfully.");
                } else {
