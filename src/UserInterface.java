...
public interface UserInterface {
    ...
    public static void registerCompetitorLate() {
        ...
        name += scanner.next();
        System.out.print("Enter Country of Origin (in Abrevaited form eg. UK): ");
        String country = scanner.next();
        System.out.print("Enter your gender: Male/Female/Other ");
        String gender = scanner.next();
        System.out.print("Enter your estimated level - (Rookie - Intermediate - Pro) ");
        String level = scanner.next();
        System.out.print("Enter your age: ");
        int age = scanner.nextInt();
        System.out.print("Select Type of competitor: 1-Surfer 2-Skater ");
    ...
    public static void changeDetails(){
        ...
        System.out.print("Ammendments Committed . . .");
    }
