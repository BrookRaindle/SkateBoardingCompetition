...
private Competitor createCompetitor(int competitorType, int competitorID, String name, String country, String gender,
    ...
    switch (competitorType) {
        case 1:
            return new Surfer(competitorID, name, country, gender, score1, score2, score3, score4, level, age);
        case 2:
            return new Skater(competitorID, name, country, gender, score1, score2, score3, score4, level, age);
        default:
